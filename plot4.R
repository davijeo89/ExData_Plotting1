...
png(file = "plot4.png")
par(mfrow=c(2,2))
plot(times, datas$Global_active_power, ylab = "Global Active Power", type = "l", xlab="")
plot(times, datas$Global_reactive_power, ylab = "Global Reactive Power", type = "l", xlab="datetime")
plot(times, datas$Voltage, ylab = "Voltage", type = "l", xlab="datetime")
